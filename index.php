    ...
    <nav class="navbar navbarMain navbar-expand-lg navbar-light p-4">
        <div class="container-fluid">
            ...
            <div class="collapse navbar1 navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-light" href="log-in.php"><i class="fa-regular fa-user"></i> Sign In</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="sign-up.php"><i class="fa-solid fa-bag-shopping"></i> Sign
                            Up</a>
                    </li>
                </ul>
            </div>
